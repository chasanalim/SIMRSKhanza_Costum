...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private String aktifkanparsial="no",kamar_inap_kasir_ralan=Sequel.cariIsi("select kamar_inap_kasir_ralan from set_jam_minimal"),caripenjab="",filter="no",bangsal=Sequel.cariIsi("select kd_bangsal from set_lokasi limit 1"),nonota="",
            ...
            Beban_Jasa_Menejemen_Tindakan_Ralan="",Utang_Jasa_Menejemen_Tindakan_Ralan="",tampildiagnosa="";
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            "Kd.Dok","Dokter Dituju","No.RM","Pasien",
        ...
        for (i = 0; i < 20; i++) {
            ...
            if(i==0){ //KD Dokter
                ...
                column.setMinWidth(0);
                column.setMaxWidth(0);
            }else if(i==8){ //Biaya Reg
                column.setMinWidth(0);
                column.setMaxWidth(0);
            }else if(i==9){ //Jenis Bayar
                column.setPreferredWidth(100);
            }else if(i==10){ //Status
                column.setPreferredWidth(80);
            }else if(i==11){ //No Rawat
                column.setPreferredWidth(105);
            }else if(i==12){ //tanggal
                column.setPreferredWidth(65);
            }else if(i==13){ //Jam
                column.setPreferredWidth(55);
            }else if(i==14){ //No Reg
                column.setPreferredWidth(47);
            }else if(i==15){ //Status Bayar
                column.setPreferredWidth(70);
            }else if(i==16){ // Status Poli
                column.setMinWidth(0);
                column.setMaxWidth(0);
            }else if(i==17){ //Kd Poli
                column.setMinWidth(0);
                column.setMaxWidth(0);
            }else if(i==18){ //Kd PJ
                column.setMinWidth(0);
                column.setMaxWidth(0);
            }else if(i==19){ //No Telp
    ...
    private void initComponents() {
        ...
        ppBerkasDiKirim = new javax.swing.JMenuItem();
        ...
        MnPenolakanMedis = new javax.swing.JMenuItem();
        ...
        ppBerkasDIterima1.setText("Task Id 4 / Mulai Pelayanan Poli / Berkas Diterima");
        ppBerkasDIterima1.setToolTipText("");
        ppBerkasDIterima1.setActionCommand("Task Id 4 / Mulai Pelayanan Poli / Berkas Diterima");
        ppBerkasDIterima1.setAutoscrolls(true);
        ...
        ppBerkasDIterima1.setPreferredSize(new java.awt.Dimension(180, 26));
        ppBerkasDIterima1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBerkasDIterima1BtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppBerkasDIterima1);
        ...
        MnRMIGD.setPreferredSize(new java.awt.Dimension(180, 26));
        ...
        MnPeniliaianAwalMedisIGD.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        MnRMRawatJalan.setPreferredSize(new java.awt.Dimension(180, 26));
        ...
        MnPenilaianFisioterapi.setPreferredSize(new java.awt.Dimension(180, 26));
        ...
        ppResume.setPreferredSize(new java.awt.Dimension(180, 26));
        ...
        ppDeteksiDIniCorona.setPreferredSize(new java.awt.Dimension(180, 26));
        ...
        MnHemodialisa.setPreferredSize(new java.awt.Dimension(180, 26));
        ...
        ppBerkasDIterima.setToolTipText("");
        ppBerkasDIterima.setActionCommand("Berkas Diterima (Task Id 4) ");
        ppBerkasDIterima.setAutoscrolls(true);
        ...
        ppBerkasDIterima.setLabel("Berkas Diterima (Task Id 4) ");
        ...
        ppBerkasDiKirim.setBackground(new java.awt.Color(255, 255, 254));
        ppBerkasDiKirim.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppBerkasDiKirim.setForeground(new java.awt.Color(50, 50, 50));
        ppBerkasDiKirim.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppBerkasDiKirim.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBerkasDiKirim.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBerkasDiKirim.setLabel("Kirim Berkas (Task Id 3)");
        ppBerkasDiKirim.setName("ppBerkasDiKirim"); // NOI18N
        ppBerkasDiKirim.setPreferredSize(new java.awt.Dimension(180, 26));
        ppBerkasDiKirim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBerkasDiKirimBtnPrintActionPerformed(evt);
            }
        });
        MnStatus.add(ppBerkasDiKirim);
        ...
        MnPenolakanMedis.setBackground(new java.awt.Color(255, 255, 254));
        MnPenolakanMedis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPenolakanMedis.setForeground(new java.awt.Color(50, 50, 50));
        MnPenolakanMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPenolakanMedis.setText("Penolakan Medis");
        MnPenolakanMedis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPenolakanMedis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPenolakanMedis.setName("MnPenolakanMedis"); // NOI18N
        MnPenolakanMedis.setPreferredSize(new java.awt.Dimension(240, 26));
        MnPenolakanMedis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPenolakanMedisActionPerformed(evt);
            }
        });
        jMenu4.add(MnPenolakanMedis);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-03-2022" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-03-2022" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-03-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-03-2022" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnCetakBebasNarkobaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakBebasNarkobaActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
                resume.setNoRm(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),DTPCari1.getDate(),DTPCari2.getDate());
                resume.tampil();
                resume.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
                ...
                try {
                    ...
                    try {
                        ...
                        if(rskasir.next()){
                            ...
                            form.setNoRm(TNoRw1.getText(),rskasir.getString("no_sep"),rskasir.getString("no_kartu"),TNoRM.getText(),TPasien.getText(),rskasir.getString("tanggal_lahir"),rskasir.getString("jkel"),rskasir.getString("nmdiagnosaawal"));
                            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                            form.setLocationRelativeTo(internalFrame1);
                            form.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
    ...
    private void ppSuratPRIBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSuratPRIBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                try {
                    pskasir=koneksi.prepareStatement("select no_sep,no_kartu,tanggal_lahir,jkel from bridging_sep where no_rawat=?");
                    try {
                        pskasir.setString(1,TNoRw.getText());
                        rskasir=pskasir.executeQuery();
                        if(rskasir.next()){
                            ...
                            form.setNoRm(TNoRw1.getText(),rskasir.getString("no_kartu"),TNoRM.getText(),TPasien.getText(),rskasir.getString("tanggal_lahir"),rskasir.getString("jkel"),rskasir.getString("no_sep"));
                            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                            form.setLocationRelativeTo(internalFrame1);
                            form.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
                ...
                try {
                    ...
                    try {
                        ...
                        if(rskasir.next()){
                            ...
                            form.setNoRm(TNoRw1.getText(),rskasir.getString("no_sep"),rskasir.getString("no_kartu"),TNoRM.getText(),TPasien.getText(),rskasir.getString("alamat"),rskasir.getString("email"),rskasir.getString("kddpjp"),rskasir.getString("nmdpdjp"));
                            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                            form.setLocationRelativeTo(internalFrame1);
                            form.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnPenolakanMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenolakanMedisActionPerformed
        if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            param.put("emailrs",akses.getemailrs());
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            Valid.MyReportqry("penolakantindakanmedis.jasper","report","::[ Persetujuan Tindakan ]::","select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"+
                "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"+
                "pasien.pnd, pasien.keluarga, pasien.namakeluarga,penjab.png_jawab,pasien.pekerjaanpj,"+
                "concat(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj) as alamatpj from pasien "+
    ...
    }//GEN-LAST:event_MnPenolakanMedisActionPerformed

    private void ppBerkasDiKirimBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDiKirimBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            Valid.editTable(tabModekasir,"reg_periksa","no_rawat",TNoRw,"stts='Berkas Terkirim'");
            if(tabModekasir.getRowCount()!=0){tampilkasir();}
        }
    }//GEN-LAST:event_ppBerkasDiKirimBtnPrintActionPerformed

    private void ppBerkasDIterima1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDIterima1BtnPrintActionPerformed
         if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_ppBerkasDIterima1BtnPrintActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnPenolakanMedis;
  ...
  private void tampilkasir() {     
    ...
    public void isCek(){
        ...
        if((MnPeniliaianAwalKeperawatanRalan.isVisible()==false)&&(MnPeniliaianAwalKeperawatanGigi.isVisible()==false)&&(MnPeniliaianAwalKeperawatanKebidanan.isVisible()==false)&&(MnPeniliaianAwalKeperawatanBayiAnak.isVisible()==false)){
            MnRMRawatJalan.setVisible(false);
        }
        
        if((MnRMIGD.isVisible()==false)&&(MnRMRawatJalan.isVisible()==false)&&(MnHemodialisa.isVisible()==false)&&(ppResume.isVisible()==false)&&(MnDiagnosa.isVisible()==false)&&(ppRiwayat.isVisible()==false)&&(ppDeteksiDIniCorona.isVisible()==false)){
        ...
        if((MnDataRalan.isVisible()==false)&&(MnPeriksaLab.isVisible()==false)&&(MnPeriksaRadiologi.isVisible()==false)&&(MnOperasi.isVisible()==false)){
            MnTindakanRalan.setVisible(false);
        }
        
        if((MnPemberianObat.isVisible()==false)&&(MnResepDOkter.isVisible()==false)&&(MnNoResep.isVisible()==false)){
            MnObatRalan.setVisible(false);
        }
        
        if((MnBilling.isVisible()==false)&&(MnBillingParsial.isVisible()==false)){
            MnPilihBilling.setVisible(false);
        }
        
        if((MnRekapHarianDokter.isVisible()==false)&&(MnRekapHarianParamedis.isVisible()==false)&&(MnRekapBulananDokter.isVisible()==false)&&(MnRekapBulananParamedis.isVisible()==false)&&(MnRekapHarianPoli.isVisible()==false)&&(MnRekapHarianObat.isVisible()==false)){
            MnRekap.setVisible(false);
        }
        
        if((MnRujuk.isVisible()==false)&&(MnPoliInternal.isVisible()==false)){
            MnRujukan.setVisible(false);
        }
        
        if((MnSEP.isVisible()==false)&&(MnSJP.isVisible()==false)&&(MnPCare.isVisible()==false)&&(MnRujukSisrute.isVisible()==false)&&(ppPasienCorona.isVisible()==false)&&(ppPerawatanCorona.isVisible()==false)&&(MnTeridentifikasiTB.isVisible()==false)){
            MnBridging.setVisible(false);
        }
