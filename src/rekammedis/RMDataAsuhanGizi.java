...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        Biokimia.setDocument(new batasInput((int)500).getKata(Biokimia));
        FisikKlinis.setDocument(new batasInput((int)500).getKata(FisikKlinis));
        RiwayatPersonal.setDocument(new batasInput((int)500).getKata(RiwayatPersonal));
        PolaMakan.setDocument(new batasInput((int)500).getKata(PolaMakan));
