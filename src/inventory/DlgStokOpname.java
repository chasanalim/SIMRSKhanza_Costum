        ...
        if(tbKamar.getRowCount()==0){
            ...
            if(nmjns.getText().equals("")&&nmkategori.getText().equals("")&&nmgolongan.getText().equals("")&&TCari.getText().equals("")){
                Valid.MyReportqry("rptOpname.jasper","report","::[ Stok Opname ]::",
                        "select opname.kode_brng, databarang.nama_brng, jenis.nama, opname.h_beli, databarang.kode_sat, opname.tanggal, opname.stok, "+
    ...
    private void tampil() {
        ...
        try{     
            if(nmjns.getText().equals("")&&nmkategori.getText().equals("")&&nmgolongan.getText().equals("")&&NmGudang.getText().equals("")&&TCari.getText().equals("")){
                pstampil=koneksi.prepareStatement("select opname.kode_brng, databarang.nama_brng, jenis.nama, opname.h_beli, databarang.kode_sat, opname.tanggal, opname.stok, "+
                     "opname.real, opname.selisih, opname.lebih, (opname.real*opname.h_beli) as totalreal,opname.nomihilang,opname.nomilebih, opname.keterangan, bangsal.kd_bangsal, bangsal.nm_bangsal, "+
                     "opname.no_batch,opname.no_faktur from opname inner join databarang on opname.kode_brng=databarang.kode_brng "+
                     "inner join bangsal on opname.kd_bangsal=bangsal.kd_bangsal "+
                     "inner join jenis on databarang.kdjns=jenis.kdjns "+
            ...
            try {     
                ...
                while(rstampil.next()){                
                    ...
                    tabMode.addRow(new Object[]{
                        rstampil.getString(1),rstampil.getString(2),rstampil.getString(3),df2.format(rstampil.getDouble(4)),
                        rstampil.getString(5),rstampil.getString(6),rstampil.getString(7),rstampil.getString(8),                              
                        rstampil.getString(9),rstampil.getString(10),df2.format(rstampil.getDouble(11)),df2.format(rstampil.getDouble(12)),
                        df2.format(rstampil.getDouble(13)),rstampil.getString(14),rstampil.getString(15),rstampil.getString(16),
                        rstampil.getString(17),rstampil.getString(18)
                    });
                }
            } catch (Exception e) {
